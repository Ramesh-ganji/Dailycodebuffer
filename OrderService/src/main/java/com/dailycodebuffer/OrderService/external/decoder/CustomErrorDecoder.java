...
import com.dailycodebuffer.OrderService.payload.response.ErrorResponse;
...
public class CustomErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        ...
        try {
            ...
            throw new OrderServiceCustomException("Internal Server Error","INTERNAL_SERVER_ERROR",
                    500);
        }
